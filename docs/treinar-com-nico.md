...
- 22 testes direcionados aprovados. Treino completo de cinco jogadas também realizado no build final; checagens de entrada em desktop/celular sem erros nem divergência entre desenvolvimento e build.
