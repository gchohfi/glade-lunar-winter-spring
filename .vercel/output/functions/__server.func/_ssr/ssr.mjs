...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B4UHw0aa.mjs");
...
var manifest = {
	"5578011dbc5082e94fe92f94c22e4e13b6cde04375d7157e15fac326e98de2f3": {
		functionName: "loadProgress_createServerFn_handler",
		importer: () => import("./player-BrsCpGnQ.mjs")
	},
	"9cd4f929bba1603bb3913cbd935442a2177027886a5c43882669c3720650e83c": {
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DSOyIJNs.mjs").then((n) => n.t),
